import { ExternalLink, Github, Quote, Share2 } from "lucide-react";
                ...
                <SectionHead
                    ...
                    title={
                        <>
                            ...
                            Supported by <span className="text-violet-400">builders</span>.
                        </>
                    }
                    lead="PriceStr is used by developers. We don't charge for access — we trust the community to support what they value."
                />
